...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_FILES["archivo"])) {
    ...
    $stmt = $conn->prepare("INSERT INTO archivosTLC (nombre, conflicto, descripcion, lugar, fecha) VALUES (?, ?, ?, ?, ?)");
    $stmt->bind_param("sssss", $nombre, $conflicto, $descripcion, $lugar, $fecha);
    $stmt->execute();
