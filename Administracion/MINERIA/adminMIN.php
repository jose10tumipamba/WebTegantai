...
<head>
    ...
    <title>Administración MINERIA</title>
    <link rel="stylesheet" href="MIN.css">
    <script src="scriptMIN.js"></script>
</head>
<body>
    <header>
        <h1><img class="logo" src="../img/logo-Tegantai.png" alt="Tegantai">Minería</h1>
    ...
    <div class="menu-secundario">
        ...
        <button class="tab-btn" onclick="location.href='adminMIN.php'">MINERÍA</button>
