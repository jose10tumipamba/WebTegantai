<?php
include 'dbYAS.php'; // Conexión a la base de datos
...
<head>
    ...
    <script src="scriptYAS.js"></script>
</head>
<body>
...
<table>
    ...
    <tr>
        ...
        <td>
            <a href="editarYAS.php?id=<?php echo $row['id']; ?>">
                <img src="imgcrud/editar.png" alt="Editar" class="icono">
            </a> 
            <a href="eliminarYAS.php?id=<?php echo $row['id']; ?>" class="eliminar-btn" onclick="return confirm('¿Eliminar archivo?');">
